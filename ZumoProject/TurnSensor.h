...
void turnSensorSetup()
{
  ...
  gyro.init();
  gyro.enableDefault();
  gyro.configureForTurnSensing();

  Serial1.print("Gyro cal");
  ...
  // Updates turn sensor until user presses A to continue.
  turnSensorReset();
...
// Displays the angle (in degrees from -180 to 180)
int returnAngle(int32_t angle)
{
  return (((int32_t)angle >> 16) * 360) >> 16;
}
